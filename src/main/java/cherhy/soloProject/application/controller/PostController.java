...
public class PostController {
    ...
    @Operation(summary = "게시물 불러오기 , 페이징")
    ...
    @Operation(summary = "게시물 불러오기 , 무한 스크롤")
    @GetMapping("/{member_id}/scroll")
    public List<PostPhotoDto> getPostScroll(@PathVariable Long member_id){
        List<PostPhotoDto> postByMemberId = postReadService.findPostByMemberId(member_id);
        return postByMemberId;
    }
