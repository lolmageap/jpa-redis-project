package cherhy.soloProject.domain.post.repository.repositoryImpl;
...
import static cherhy.soloProject.domain.photo.entity.QPhoto.*;
import static cherhy.soloProject.domain.post.entity.QPost.*;
